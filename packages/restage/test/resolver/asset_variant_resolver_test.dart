...
final class _PaywallAssetBundle extends CachingAssetBundle {
  ...
  Future<ByteData> load(String key) async {
    // The asset manifest is how the SDK finds packaged bundles when a logical
    // path is not loose; it is not a delivery artifact, and these tests are
    // about which delivery artifacts a resolve reads.
