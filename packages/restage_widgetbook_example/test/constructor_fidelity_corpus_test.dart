  ...
  test('one named corpus exercises the shared accepted constructor truth', () {
    ...
    expect(
      ...
      allOf(<Matcher>[
        ...
        contains('this.resetProof = true'),
        contains('this.whenEnabledChanges = true'),
        contains('this.reportCount = true'),
        contains('resetProof: () {}'),
        contains('whenEnabledChanges: (_) {}'),
        contains('reportCount: (_) {}'),
        contains('resetProof: _RestageEventArg('),
        contains('whenEnabledChanges: _RestageEventArg('),
        contains('reportCount: _RestageEventArg('),
        isNot(contains('resetProof: _RestageBoolArg(')),
        isNot(contains('whenEnabledChanges: _RestageBoolArg(')),
        isNot(contains('reportCount: _RestageBoolArg(')),
        isNot(contains('args.resetProof')),
        isNot(contains('args.whenEnabledChanges')),
        isNot(contains('args.reportCount')),
      ]),
    );
  });
